...
\author{\IEEEauthorblockN{Giuseppe Primiero, Franco Raimondi, Taolue Chen and Rajagopal Nagarajan}
...
\noindent {\em Acknowledgement.} Taolue Chen is partially supported by  
UK EPSRC grant (EP/P00430X/1) and European CHIST-ERA project SUCCESS.
